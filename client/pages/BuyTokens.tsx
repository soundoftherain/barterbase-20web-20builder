              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      You selected {currency} payment. We will guide you to connect a wallet and sign a purchase agreement. No custodial services.
                    </DialogDescription>
                  </DialogHeader>
          ...
          <Card className="bg-card/70 backdrop-blur">
            ...
            <CardContent className="space-y-4 text-sm text-muted-foreground">
              <div className="flex items-start gap-3">
                ...
                <p>Backs a decentralized marketplace for buying, selling, and bartering supplies with crypto.</p>
              </div>
              <div className="flex items-start gap-3">
                <Shield className="mt-0.5 size-4 text-primary" />
                <p>Supports EMP-resilient communication gear and connectivity for the community.</p>
              </div>
              <div className="flex items-start gap-3">
                <Shield className="mt-0.5 size-4 text-primary" />
                <p>Enables tokenization of physical land as NFTs with governance controls.</p>
              </div>
            </CardContent>
          </Card>
        </div>
